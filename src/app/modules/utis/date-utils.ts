...
export function formatDate(date: Date | moment.Moment| null, pattern: string): string {
...
export function toMoment(date: Date | moment.Moment | null): moment.Moment {
  return isDate(date) ? moment(date as Date) : date as moment.Moment;
}

export function toFirstHour(date: Date | moment.Moment): Date | null {
...
export function toLastHour(date: Date | moment.Moment): Date | null {
  if (isNullOrUndefined(date)) return null;
  return toMoment(date)
    .hours(23)
    .minutes(59)
...
export function toFirstDayOfMoth(date: Date | moment.Moment): Date | null {
  if (isNullOrUndefined(date)) return null;
  return toMoment(date)
    .startOf('month')
    .toDate();
...
export function toLastDayOfMoth(date: Date | moment.Moment): Date | null {
  if (isNullOrUndefined(date)) return null;
  return toMoment(date)
    .endOf('month')
    .toDate();
...
export function toFirstDayOfWeek(date: Date | moment.Moment): Date | null {
  if (isNullOrUndefined(date)) return null;
  return toMoment(date)
    .startOf('week')
    .toDate();
...
export function toLastDayOfWeek(date: Date | moment.Moment): Date | null {
  if (isNullOrUndefined(date)) return null;
  return toMoment(date)
    .endOf('week')
    .toDate();
 ...
 */
export function toDateOnly(date: moment.Moment | Date): moment.Moment | null {
  if (isNullOrUndefined(date)) return null;
  return toMoment(date)
    .hour(0)
    .minute(0)
